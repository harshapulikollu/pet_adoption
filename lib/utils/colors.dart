...
const kShadowColorPurple =  Color(0xFF552080);
const kShadowColorNeoPaccha = Color(0xFF727F20);
const kShadowColorManna = Color(0xFF806623);
const kShadowColorPinkPong = Color(0xFF802138);
const kShadowColorOrangeSunshine = Color(0xFF804322);
